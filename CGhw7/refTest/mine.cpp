...
int main() {
    ...
    int debugDepthQuad = shaderprogram(debug_quad_vertex, debug_quad_depth_fragment);
	...
	const GLuint SHADOW_WIDTH = 1200, SHADOW_HEIGHT = 800;
	GLuint depthMapFBO;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (show_phong_window)
		{
			...
			glUniform3fv(glGetUniformLocation(shader, "viewPos"), 1, &camera.cameraPos[0]);
